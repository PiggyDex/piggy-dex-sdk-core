import { V2_FACTORY_ADDRESSES, V2_ROUTER_ADDRESSES } from './addresses'
...
describe('addresses', () => {
  describe('swap router 02 addresses', () => {
    ...
    it('should return the correct address for espace_testnet', () => {
      const router_address = V2_ROUTER_ADDRESSES[ChainId.ESPACE_TESTNET]
      expect(router_address).toEqual('0x9DFDc90b14B51b421aF2b911E0BE3229E7510288')

      const factory_address = V2_FACTORY_ADDRESSES[ChainId.ESPACE_TESTNET]
      expect(factory_address).toEqual('0x5D663484bF71Cd760831E44c21F3035432C0F177')
    })
  })
})
